...
export const GP_HISTORY: Record<string, GrandPrixHistory> = {
  ...
  monza: {
    ...
    laps: 53,
    lapRecord: { driver: 'Lando Norris', time: '1:20.901', year: 2025 },
    ...
    lastYear: {
      season: 2025,
      race: [
        { name: 'Max Verstappen', team: 'Red Bull', time: '1:13:24.325' },
        { name: 'Lando Norris', team: 'McLaren', time: '+19.207' },
        { name: 'Oscar Piastri', team: 'McLaren', time: '+21.351' },
        { name: 'Charles Leclerc', team: 'Ferrari', time: '+25.624' },
        { name: 'George Russell', team: 'Mercedes', time: '+32.881' },
        { name: 'Lewis Hamilton', team: 'Ferrari', time: '+37.449' },
        { name: 'Alexander Albon', team: 'Williams', time: '+50.537' },
        { name: 'Gabriel Bortoleto', team: 'Kick Sauber', time: '+58.484' },
        { name: 'Kimi Antonelli', team: 'Mercedes', time: '+59.762' },
        { name: 'Isack Hadjar', team: 'Racing Bulls', time: '+1:03.891' },
        { name: 'Carlos Sainz', team: 'Williams', time: '+1:04.469' },
        { name: 'Oliver Bearman', team: 'Haas', time: '+1:19.288' },
        { name: 'Yuki Tsunoda', team: 'Red Bull', time: '+1:20.701' },
        { name: 'Liam Lawson', team: 'Racing Bulls', time: '+1:22.351' },
        { name: 'Esteban Ocon', team: 'Haas', time: '+1 lap' },
        { name: 'Pierre Gasly', team: 'Alpine', time: '+1 lap' },
        { name: 'Franco Colapinto', team: 'Alpine', time: '+1 lap' },
        { name: 'Lance Stroll', team: 'Aston Martin', time: '+1 lap' },
        { name: 'Fernando Alonso', team: 'Aston Martin', time: 'DNF' },
        { name: 'Nico Hülkenberg', team: 'Kick Sauber', time: 'DNS' },
      ],
      quali: [
        { name: 'Max Verstappen', team: 'Red Bull', time: '1:18.792' },
        { name: 'Lando Norris', team: 'McLaren', time: '1:18.869' },
        { name: 'Oscar Piastri', team: 'McLaren', time: '1:18.982' },
        { name: 'Charles Leclerc', team: 'Ferrari', time: '1:19.007' },
        { name: 'Lewis Hamilton', team: 'Ferrari', time: '1:19.124' },
        { name: 'George Russell', team: 'Mercedes', time: '1:19.157' },
        { name: 'Kimi Antonelli', team: 'Mercedes', time: '1:19.200' },
        { name: 'Gabriel Bortoleto', team: 'Kick Sauber', time: '1:19.390' },
        { name: 'Fernando Alonso', team: 'Aston Martin', time: '1:19.424' },
        { name: 'Yuki Tsunoda', team: 'Red Bull', time: '1:19.519' },
        { name: 'Oliver Bearman', team: 'Haas', time: '1:19.446' },
        { name: 'Nico Hülkenberg', team: 'Kick Sauber', time: '1:19.498' },
        { name: 'Carlos Sainz', team: 'Williams', time: '1:19.528' },
        { name: 'Alexander Albon', team: 'Williams', time: '1:19.583' },
        { name: 'Esteban Ocon', team: 'Haas', time: '1:19.707' },
        { name: 'Isack Hadjar', team: 'Racing Bulls', time: '1:19.917' },
        { name: 'Lance Stroll', team: 'Aston Martin', time: '1:19.948' },
        { name: 'Franco Colapinto', team: 'Alpine', time: '1:19.992' },
        { name: 'Pierre Gasly', team: 'Alpine', time: '1:20.103' },
