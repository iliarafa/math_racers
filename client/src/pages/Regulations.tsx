        ...
        <div className="max-w-2xl md:max-w-3xl mx-auto">
          ...
          <div className="space-y-6 md:space-y-8">
            <section>
              ...
              <p className="text-black/50 text-sm md:text-base md:text-base">Each correct answer advances you one sector</p>
            </section>
            ...
            <section>
              ...
              <div className="text-black/50 text-sm md:text-base space-y-1">
                ...
                <p><span className="text-black/70">Random</span> — conditions may change mid-race</p>
              </div>
            </section>

            <section>
              <h2 className="text-lg md:text-xl font-bold text-black border-b border-black/20 pb-2 mb-3">Practice</h2>
              <p className="text-black text-sm md:text-base leading-relaxed mb-2">
