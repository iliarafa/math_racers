    ...
    articles: [
      {
        ...
        details: [
          ...
          "#Difficulty",
          "Adaptive (default) — difficulty changes during the race from your speed and accuracy (starts at Karting).",
          "Locked — pick Karting / F3 / F2 / F1 before the race; level stays fixed (no promotion or demotion).",
          "Grand Prix Practice is always Adaptive; Qualifying and Race Day use the level achieved in Practice.",
  ...
  },
  {
    ...
    articles: [
      ...
      },
      {
        ...
        details: [
          "Adaptive (default) — difficulty adjusts from your speed and accuracy.",
          "Locked — pick Karting / F3 / F2 / F1; level stays fixed for the session.",
