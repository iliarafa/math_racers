        ...
        <div className="max-w-2xl md:max-w-4xl mx-auto">
          ...
          <div className="mb-5">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-lg md:text-xl font-bold tracking-widest uppercase text-black">Leaderboard</h1>
            </div>
            <p className="text-xs text-black/70 mt-1 ml-9">Record 100 laps in Free Practice to enter.</p>
          </div>
          ...
          {loading ? (
            ...
            <div className="flex flex-col items-center justify-center py-20 space-y-3">
              ...
              <p className="text-black/50 text-xs">Complete a 57-lap PST cycle to appear here</p>
            </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-shrink-0 text-right">
                        <div className={cn("text-lg font-bold", rank <= 3 ? "text-yellow-500" : "text-black")} style={{ fontFamily: 'Oxanium, sans-serif' }}>
                          {entry.score.toLocaleString()}
                        </div>
                        <div className="text-[10px] text-black/50 uppercase tracking-wider">pts</div>
                      </div>
                    </div>
                  );
                })}
